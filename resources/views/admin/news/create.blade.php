                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="text" id="title" name="title" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white" value="{{ old('title') }}" placeholder="Judul Berita Baru">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="description" name="description" rows="8" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white">{{ old('description') }}</textarea>
                                @error('description') <span class="text-red-400 text-sm">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        {{-- Kolom Kanan: Placeholder/Preview --}}
                        <div class="bg-white p-4 rounded flex items-center justify-center text-gray-800 font-bold" style="min-height: 400px;">
                            <h3 class="text-xl">Preview Poster</h3>
                        </div>
                    </div>

                    <div class="flex justify-end space-x-4 mt-6">
                        <a href="{{ route('news.index') }}" class="bg-[#B03C36] hover:bg-[#97332E] text-white font-bold py-2 px-6 rounded transition duration-150">Batal</a>
