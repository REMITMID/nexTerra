<x-app-layout>
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            {{-- Form Tambah/Edit Edukasi --}}
            <div class="bg-[#38761D] p-6 rounded-lg shadow-md text-white">
                <h2 class="text-2xl font-bold mb-6">Tambah Konten Edukasi Baru</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="text" id="title" name="title" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white" value="{{ old('title') }}" placeholder="Orang Utan (Pongo)">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea id="content" name="content" rows="8" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white">{{ old('content') }}</textarea>
                                @error('content') <span class="text-red-400 text-sm">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        {{-- Kolom Kanan: Preview Kosong (Sesuai Gambar) --}}
                        <div class="bg-white p-4 rounded flex items-center justify-center text-gray-800 font-bold" style="min-height: 400px;">
                            <h3 class="text-xl">Edukasi Preview</h3>
                        </div>
                    </div>
