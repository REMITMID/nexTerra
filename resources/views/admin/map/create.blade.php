    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            ...
            <div class="bg-[#38761D] p-6 rounded-lg shadow-md text-white">
                <h2 class="text-2xl font-bold mb-6">Tambah Data Peta Baru</h2>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white" value="{{ old('name') }}" placeholder="Contoh: Indonesia">
