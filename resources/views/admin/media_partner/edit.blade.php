                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <div class="mb-4">
                                ...
                                <input type="text" id="name" name="name" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white" value="{{ old('name', $partner->name) }}" placeholder="Nama Mitra">
                            ...
                            <div class="mb-4">
                                ...
                                @if ($partner->logo_path)
                                    <p class="text-sm text-gray-300 mt-2">Logo saat ini:</p>
                                    <img src="{{ asset('storage/' . $partner->logo_path) }}" alt="{{ $partner->name }}" class="mt-2 w-32 h-32 object-contain rounded">
                                @endif
                            </div>
                            
                            <div class="mb-4">
                                <label for="link" class="block text-sm font-medium mb-1">Link Media Partner</label>
                                <input type="url" id="link" name="link" class="w-full p-2 rounded bg-gray-700 border border-gray-600 focus:ring focus:ring-gray-500 text-white" value="{{ old('link', $partner->link) }}" placeholder="https://website-mitra.com">
                                @error('link') <span class="text-red-400 text-sm">{{ $message }}</span> @enderror
                            </div>
                        </div>

                        {{-- Kolom Kanan: Preview/Kontrol --}}
                        <div class="flex flex-col justify-end" style="min-height: 250px;">
